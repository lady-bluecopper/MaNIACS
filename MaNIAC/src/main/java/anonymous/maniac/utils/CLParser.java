package anonymous.maniac.utils;
...
public class CLParser {
    ...
    private static void parseArg(String key, String value) {
        ...
        } else if (key.equalsIgnoreCase("numLabels")) {
            Settings.numLabels = Integer.parseInt(value);
        ...
        } else if (key.equalsIgnoreCase("precomputed")) {
            Settings.preComputed = Boolean.valueOf(value);

...
abstract public class Utils {
     ...
     */
    public static void print_labeling(java.io.PrintStream stream, Map<Integer, Integer> labeling) {
        String sep = "";
        stream.print("{");
        for (Entry<Integer, Integer> e : labeling.entrySet()) {
     ...
     */
 /*
    public static void print_permutation(java.io.PrintStream stream, int[] perm) {
